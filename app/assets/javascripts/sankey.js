...
//            if (link.source == null || link.target == null) console.log(nodes[link.source]);
...
//        }
        ...
        function initializeNodeDepth() {
            ...
            links.forEach(function(link) {
                link.dy = link.value * ky;// + (nodeMin/link.source.sourceLinks.length);
            });
        }
